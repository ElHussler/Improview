// PostBlob method uses XHR2 and FormData to submit recorded blob to the PHP server
...
function deleteAudioVideoFiles() {
    ...
    xhr('/Interview/DeleteFile', formData, null, null, function (response) {
...
function xhr(url, data, progress, percentage, callback) {
    ...
    if (url.indexOf('/Interview/DeleteFile') == -1) {
